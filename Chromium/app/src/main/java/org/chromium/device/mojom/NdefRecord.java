...
public final class NdefRecord extends org.chromium.mojo.bindings.Struct {
    ...
    public static NdefRecord decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new NdefRecord(elementsOrVersion);
                ...
                result.recordType = decoder0.readString(8, false);
                }
                {
                ...
                result.encoding = decoder0.readString(32, true);
                }
                {
                    
                result.lang = decoder0.readString(40, true);
                }
                {
                    
                result.data = decoder0.readBytes(48, org.chromium.mojo.bindings.BindingsHelper.NOTHING_NULLABLE, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.recordType, 8, false);
        
        encoder0.encode(this.mediaType, 16, true);
        
        encoder0.encode(this.id, 24, true);
        
        encoder0.encode(this.encoding, 32, true);
        
        encoder0.encode(this.lang, 40, true);
        
        encoder0.encode(this.data, 48, org.chromium.mojo.bindings.BindingsHelper.NOTHING_NULLABLE, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        
        encoder0.encode(this.payloadMessage, 56, true);
    }
}