...
final class ExploreSitesBridgeJni implements ExploreSitesBridge.Natives {
  ...
  @Override
  public int getIconVariation() {
    return (int)N.MNNGhUis();
  }
  ...
  @Override
  public void getEspCatalog(Profile profile, List<ExploreSitesCategory> result,
      Callback<List<ExploreSitesCategory>> callback) {
    N.MvL4I0$V(profile, result, callback);
  }
  ...
  @Override
  public void getCategoryImage(Profile profile, int categoryID, int pixelSize,
      Callback<Bitmap> callback) {
    N.MCX5FLGk(profile, categoryID, pixelSize, callback);
  }
  ...
  @Override
  public void incrementNtpShownCount(Profile profile, int categoryId) {
    N.MjlDtqYM(profile, categoryId);
  }
