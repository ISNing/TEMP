...
final class ServiceWorkerPaymentAppBridgeJni implements ServiceWorkerPaymentAppBridge.Natives {
  ...
  @Override
  public void canMakePayment(WebContents webContents, long registrationId,
      ...
      ServiceWorkerPaymentAppBridge.CanMakePaymentCallback callback) {
    N.MRWgCpy3(webContents, registrationId, serviceWorkerScope, paymentRequestId, topOrigin, paymentRequestOrigin, methodData, modifiers, callback);
  }
