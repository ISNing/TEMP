...
final class ToolbarSceneLayerJni implements ToolbarSceneLayer.Natives {
  ...
  public void updateToolbarLayer(long nativeToolbarSceneLayer, ToolbarSceneLayer caller,
      ...
      int urlBarResourceId, float urlBarAlpha, int urlBarColor, float topOffset, float viewHeight,
      boolean visible, boolean showShadow) {
    N.MNYME7b7(nativeToolbarSceneLayer, caller, resourceManager, resourceId, toolbarBackgroundColor, urlBarResourceId, urlBarAlpha, urlBarColor, topOffset, viewHeight, visible, showShadow);
  }
