...
public abstract class ChromeSwitches {
    ...
    // Into
    //     ../../chrome/android/java_templates/ChromeSwitches.java.tmpl
    ...
    // prompts.
    public static final String DENY_PERMISSION_PROMPTS = "deny-permission-prompts";
    ...
    public static final String ENABLE_DEV_TOOLS_EXPERIMENTS = "enable-devtools-experiments";
    ...
    public static final String FAST_START = "fast-start";
    ...
    public static final String FORCE_ANDROID_APP_MODE = "force-android-app-mode";
    ...
    // the app to be installed if it hasn't been already.
    public static final String FORCE_WEB_APP_MODE = "force-web-app-mode";
    ...
    public static final String ORIGINAL_PROCESS_START_TIME = "original-process-start-time";
    ...
    // disabled by default.
    public static final String WEB_UI_TAB_STRIP = "webui-tab-strip";
    ...
    public static final String ENABLE_FULLSCREEN_TOOLBAR_REVEAL = "enable-fullscreen-toolbar-reveal";
    ...
    public static final String WATCHER_PROCESS = "watcher";
