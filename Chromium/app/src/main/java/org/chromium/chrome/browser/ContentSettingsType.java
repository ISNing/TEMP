...
@IntDef({
    ...
    ContentSettingsType.ACCESSIBILITY_EVENTS, ContentSettingsType.CLIPBOARD_READ,
    ContentSettingsType.CLIPBOARD_WRITE, ContentSettingsType.PLUGINS_DATA,
    ContentSettingsType.PAYMENT_HANDLER, ContentSettingsType.USB_GUARD,
    ContentSettingsType.BACKGROUND_FETCH, ContentSettingsType.INTENT_PICKER_DISPLAY,
    ContentSettingsType.IDLE_DETECTION, ContentSettingsType.SERIAL_GUARD,
    ...
    ContentSettingsType.BLUETOOTH_CHOOSER_DATA, ContentSettingsType.NUM_TYPES
})
...
public @interface ContentSettingsType {
   ...
   */
  int CLIPBOARD_READ = 35;
  /**
   * This is special-cased in the permissions layer to always allow, and as such doesn't have
   * associated prefs data.
   */
  int CLIPBOARD_WRITE = 36;
  /**
   ...
   */
  int INTENT_PICKER_DISPLAY = 41;
  /**
   * Used to store whether to allow a website to detect user active/idle state.
   */
  int IDLE_DETECTION = 42;
  /**
   ...
   * worked out.
   */
  int WAKE_LOCK_SCREEN = 49;
  int WAKE_LOCK_SYSTEM = 50;
  /**
   * Legacy SameSite cookie behavior. This disables SameSiteByDefaultCookies and
   * CookiesWithoutSameSiteMustBeSecure, and forces the legacy behavior where cookies that don't
   * specify SameSite are treated as SameSite=None and SameSite=None cookies are not required to be
   * Secure. This will also be used to revert to legacy behavior when future changes in cookie
   * handling are introduced.
   */
  int LEGACY_COOKIE_ACCESS = 51;
  /**
   * Content settings which stores whether to allow sites to ask for permission to save changes to
   * an original file selected by the user through the Native File System API.
   */
  int NATIVE_FILE_SYSTEM_WRITE_GUARD = 52;
  /**
   * Content settings for installed web apps that browsing history may be inferred from e.g. last
   * update check timestamp.
   */
  int INSTALLED_WEB_APP_METADATA = 53;
  /**
