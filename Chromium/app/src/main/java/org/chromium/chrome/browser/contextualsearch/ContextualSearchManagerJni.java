...
final class ContextualSearchManagerJni implements ContextualSearchManager.Natives {
  ...
  @Override
  public String getTargetLanguage(long nativeContextualSearchManager,
      ContextualSearchManager caller) {
    return (String)N.MFSDbCR_(nativeContextualSearchManager, caller);
  }

  @Override
  public String getAcceptLanguages(long nativeContextualSearchManager,
      ContextualSearchManager caller) {
    return (String)N.MAPf_NIE(nativeContextualSearchManager, caller);
  }
