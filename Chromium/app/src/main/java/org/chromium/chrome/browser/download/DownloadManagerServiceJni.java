...
final class DownloadManagerServiceJni implements DownloadManagerService.Natives {
  ...
  @Override
  public long init(DownloadManagerService caller, boolean isProfileCreated) {
    return (long)N.MeJ$lv4P(caller, isProfileCreated);
  }
  ...
  @Override
  public void onProfileCreated(long nativeDownloadManagerService, DownloadManagerService caller) {
    N.M070u0sx(nativeDownloadManagerService, caller);
  }
