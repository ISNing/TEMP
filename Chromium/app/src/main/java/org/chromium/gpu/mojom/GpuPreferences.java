...
public final class GpuPreferences extends org.chromium.mojo.bindings.Struct {
    ...
    public static GpuPreferences decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new GpuPreferences(elementsOrVersion);
                ...
                result.ignoreGpuBlacklist = decoder0.readBoolean(11, 6);
                }
                {
                ...
                result.disableOopRasterization = decoder0.readBoolean(20, 0);
                }
                {
                    
                result.enableOopRasterizationDdl = decoder0.readBoolean(20, 1);
                }
                {
                    
                result.watchdogStartsBackgrounded = decoder0.readBoolean(20, 2);
                }
                {
                    
                result.enforceVulkanProtectedMemory = decoder0.readBoolean(20, 3);
                }
                {
                ...
                result.enableGpuBlockedTimeMetric = decoder0.readBoolean(21, 1);
                }
                {
                ...
                result.grContextType = decoder0.readInt(32);
                    GrContextType.validate(result.grContextType);
                }
                {
                    
                result.useVulkan = decoder0.readInt(36);
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.ignoreGpuBlacklist, 11, 6);
        ...
        encoder0.encode(this.disableOopRasterization, 20, 0);
        
        encoder0.encode(this.enableOopRasterizationDdl, 20, 1);
        
        encoder0.encode(this.watchdogStartsBackgrounded, 20, 2);
        
        encoder0.encode(this.enforceVulkanProtectedMemory, 20, 3);
        ...
        encoder0.encode(this.enableGpuBlockedTimeMetric, 21, 1);
        ...
        encoder0.encode(this.grContextType, 32);
        
        encoder0.encode(this.useVulkan, 36);
    }
}