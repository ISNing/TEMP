...
final class WindowAndroidJni implements WindowAndroid.Natives {
  ...
  @Override
  public void onVSync(long nativeWindowAndroid, WindowAndroid caller, long vsyncTimeMicros,
      long vsyncPeriodMicros) {
    N.MaRRNbDu(nativeWindowAndroid, caller, vsyncTimeMicros, vsyncPeriodMicros);
  }
