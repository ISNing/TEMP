...
public final class CssSampleId {
    ...
    public static final int INTERNAL_EFFECTIVE_ZOOM = 0;
    ...
    public static final int WEBKIT_APPEARANCE = 175;
    ...
    public static final int WEBKIT_FONT_SIZE_DELTA = 241;
    ...
    public static final int INTRINSIC_BLOCK_SIZE = 648;
    public static final int INTRINSIC_HEIGHT = 649;
    public static final int INTRINSIC_INLINE_SIZE = 650;
    public static final int INTRINSIC_SIZE = 651;
    public static final int INTRINSIC_WIDTH = 652;
    public static final int RENDER_SUBTREE = 653;
