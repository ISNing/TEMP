...
class ClipboardHost_Internal {
    ...
    private static final int WRITE_RAW_DATA_ORDINAL = 12;

    private static final int WRITE_BOOKMARK_ORDINAL = 13;

    private static final int WRITE_IMAGE_ORDINAL = 14;

    private static final int COMMIT_WRITE_ORDINAL = 15;
...
org.chromium.mojo_base.mojom.String16 format, org.chromium.mojo_base.mojom.BigBuffer data) {
            ...
            ClipboardHostWriteRawDataParams _message = new ClipboardHostWriteRawDataParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(WRITE_RAW_DATA_ORDINAL)));
...
org.chromium.skia.mojom.Bitmap image) {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case WRITE_RAW_DATA_ORDINAL: {

                        ClipboardHostWriteRawDataParams data =
                                ClipboardHostWriteRawDataParams.deserialize(messageWithHeader.getPayload());

                        getImpl().writeRawData(data.format, data.data);
                        return true;
                    }
    ...
    static final class ClipboardHostWriteRawDataParams extends org.chromium.mojo.bindings.Struct {
        ...
        private ClipboardHostWriteRawDataParams(int version) {
            super(STRUCT_SIZE, version);
        }

        public ClipboardHostWriteRawDataParams() {
            this(0);
        }

        public static ClipboardHostWriteRawDataParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ClipboardHostWriteRawDataParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ClipboardHostWriteRawDataParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ClipboardHostWriteRawDataParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new ClipboardHostWriteRawDataParams(elementsOrVersion);
                    {
