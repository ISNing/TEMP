...
class ServiceWorker_Internal {
    ...
    private static final int SET_IDLE_TIMER_DELAY_TO_ZERO_ORDINAL = 21;
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case INITIALIZE_GLOBAL_SCOPE_ORDINAL: {
                        ...
                        getImpl().initializeGlobalScope(data.serviceWorkerHost, data.registrationInfo, data.serviceWorkerInfo, data.fetchHandlerExistence);
                        return true;
                    }
