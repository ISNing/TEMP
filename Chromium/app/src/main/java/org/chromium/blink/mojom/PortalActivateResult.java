...
public final class PortalActivateResult {
    ...
    public static final int PREDECESSOR_WAS_ADOPTED = 1; // PREDECESSOR_WILL_UNLOAD + 1
    public static final int REJECTED_DUE_TO_PREDECESSOR_NAVIGATION = 2; // PREDECESSOR_WAS_ADOPTED + 1
    public static final int ABORTED_DUE_TO_BUG = 3; // REJECTED_DUE_TO_PREDECESSOR_NAVIGATION + 1
