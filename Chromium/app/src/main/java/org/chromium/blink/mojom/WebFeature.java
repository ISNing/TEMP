...
public final class WebFeature {
    ...
    public static final int UPGRADE_INSECURE_REQUESTS_UPGRADED_REQUEST_OBSOLETE = 741;
    ...
    public static final int DELEGATE_FOCUS_NOT_FIRST_IN_FLAT_TREE = 3031;
    ...
    public static final int EVALUATE_SCRIPT_MOVED_BETWEEN_ELEMENT_DOCUMENTS = 3045;
    ...
    public static final int WEB_NFC_NDEF_WRITER_PUSH = 3095;
    ...
    public static final int NUMBER_OF_FEATURES = 3116; // SCROLL_SNAP_CAUSES_SCROLL_ON_INITIAL_LAYOUT + 1
