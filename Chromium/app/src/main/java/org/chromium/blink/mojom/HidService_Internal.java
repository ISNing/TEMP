...
ConnectResponse callback) {
    ...
    static final class HidServiceRequestDeviceResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(16, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public org.chromium.device.mojom.HidDeviceInfo device;
        ...
        public static HidServiceRequestDeviceResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new HidServiceRequestDeviceResponseParams(elementsOrVersion);
                    ...
                    result.device = org.chromium.device.mojom.HidDeviceInfo.decode(decoder1);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.device, 8, true);
        }
    }
    ...
    static class HidServiceRequestDeviceResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                mCallback.call(response.device);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static class HidServiceRequestDeviceResponseParamsProxyToResponder implements HidService.RequestDeviceResponse {
        ...
        @Override
        public void call(org.chromium.device.mojom.HidDeviceInfo device) {
