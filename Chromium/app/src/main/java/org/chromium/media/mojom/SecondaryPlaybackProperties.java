...
public final class SecondaryPlaybackProperties extends org.chromium.mojo.bindings.Struct {
    ...
    public static SecondaryPlaybackProperties decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new SecondaryPlaybackProperties(elementsOrVersion);
                ...
                result.videoCodecProfile = decoder0.readInt(16);
                    VideoCodecProfile.validate(result.videoCodecProfile);
                }
                {
                    
                result.audioEncryptionScheme = decoder0.readInt(20);
                ...
                result.videoEncryptionScheme = decoder0.readInt(40);
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.videoCodecProfile, 16);
        
        encoder0.encode(this.audioEncryptionScheme, 20);
        
        encoder0.encode(this.audioDecoderName, 24, false);
        
        encoder0.encode(this.videoDecoderName, 32, false);
        
        encoder0.encode(this.videoEncryptionScheme, 40);
