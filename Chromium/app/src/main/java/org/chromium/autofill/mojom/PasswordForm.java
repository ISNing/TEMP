...
public final class PasswordForm extends org.chromium.mojo.bindings.Struct {
    ...
    public static PasswordForm decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new PasswordForm(elementsOrVersion);
                ...
                result.preferred = decoder0.readBoolean(12, 3);
                }
                {
                    
                result.blacklistedByUser = decoder0.readBoolean(12, 4);
                }
                {
                    
                result.skipZeroClick = decoder0.readBoolean(12, 5);
                }
                {
                    
                result.wasParsedUsingAutofillPredictions = decoder0.readBoolean(12, 6);
                }
                {
                    
                result.isPublicSuffixMatch = decoder0.readBoolean(12, 7);
                }
                {
                    
                result.isAffiliationBasedMatch = decoder0.readBoolean(13, 0);
                }
                {
                    
                result.onlyForFallback = decoder0.readBoolean(13, 1);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.preferred, 12, 3);
        
        encoder0.encode(this.blacklistedByUser, 12, 4);
        
        encoder0.encode(this.skipZeroClick, 12, 5);
        
        encoder0.encode(this.wasParsedUsingAutofillPredictions, 12, 6);
        
        encoder0.encode(this.isPublicSuffixMatch, 12, 7);
        
        encoder0.encode(this.isAffiliationBasedMatch, 13, 0);
        
        encoder0.encode(this.onlyForFallback, 13, 1);
