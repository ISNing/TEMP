...
public  final class LoopbackServerProto extends
  ...
  private LoopbackServerProto() {
    ...
    keystoreKeys_ = com.google.protobuf.GeneratedMessageLite.emptyProtobufList();
  }
  ...
  private com.google.protobuf.Internal.ProtobufList<String> keystoreKeys_;
  /**
   * <pre>
   ...
   */
  public java.util.List<String> getKeystoreKeysList() {
   ...
   * <code>repeated string keystore_keys = 4;</code>
   */
  public java.lang.String getKeystoreKeys(int index) {
   ...
   * <code>repeated string keystore_keys = 4;</code>
   */
  private void addKeystoreKeysBytes(
      com.google.protobuf.ByteString value) {
    if (value == null) {
    throw new NullPointerException();
  }
  ensureKeystoreKeysIsMutable();
    keystoreKeys_.add(value.toStringUtf8());
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < keystoreKeys_.size(); i++) {
      output.writeString(4, keystoreKeys_.get(i));
    }
    ...
    }
    {
      ...
      for (int i = 0; i < keystoreKeys_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream
          .computeStringSizeNoTag(keystoreKeys_.get(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends
    ...
    public com.google.protobuf.ByteString
        getKeystoreKeysBytes(int index) {
      return instance.getKeystoreKeysBytes(index);
    }
    /**
     * <pre>
     * All Keystore keys known to the server.
     ...
     * <code>repeated string keystore_keys = 4;</code>
     */
    public Builder addKeystoreKeys(
        java.lang.String value) {
      copyOnWrite();
     ...
     * <code>repeated string keystore_keys = 4;</code>
     */
    public Builder addKeystoreKeysBytes(
        com.google.protobuf.ByteString value) {
      copyOnWrite();
      instance.addKeystoreKeysBytes(value);
      return this;
    }
