...
public  final class SharingSpecificFields extends
  ...
  public enum EnabledFeatures
    ...
    UNKNOWN(0),
    /**
     * <code>CLICK_TO_CALL = 1;</code>
     */
    CLICK_TO_CALL(1),
    /**
     * <code>SHARED_CLIPBOARD = 2;</code>
     */
    SHARED_CLIPBOARD(2),
    /**
    ...
    public static EnabledFeatures forNumber(int value) {
      switch (value) {
        ...
        case 1: return CLICK_TO_CALL;
        case 2: return SHARED_CLIPBOARD;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (((bitField0_ & 0x00000008) == 0x00000008)) {
      output.writeString(5, getSenderIdFcmToken());
    }
    if (((bitField0_ & 0x00000010) == 0x00000010)) {
      output.writeBytes(6, senderIdP256Dh_);
    }
    if (((bitField0_ & 0x00000020) == 0x00000020)) {
      output.writeBytes(7, senderIdAuthSecret_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000008) == 0x00000008)) {
      size += com.google.protobuf.CodedOutputStream
        .computeStringSize(5, getSenderIdFcmToken());
    }
    if (((bitField0_ & 0x00000010) == 0x00000010)) {
      size += com.google.protobuf.CodedOutputStream
        .computeBytesSize(6, senderIdP256Dh_);
    }
    if (((bitField0_ & 0x00000020) == 0x00000020)) {
      size += com.google.protobuf.CodedOutputStream
        .computeBytesSize(7, senderIdAuthSecret_);
    }
