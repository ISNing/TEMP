...
@IntDef({
    ...
    ModelType.OS_PRIORITY_PREFERENCES, ModelType.PROXY_TABS, ModelType.FIRST_PROXY_TYPE,
    ModelType.LAST_PROXY_TYPE, ModelType.LAST_USER_MODEL_TYPE, ModelType.NIGORI,
    ModelType.DEPRECATED_EXPERIMENTS, ModelType.LAST_REAL_MODEL_TYPE
})
