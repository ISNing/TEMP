...
public final class UrlLoaderFactoryParams extends org.chromium.mojo.bindings.Struct {
    ...
    public static UrlLoaderFactoryParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new UrlLoaderFactoryParams(elementsOrVersion);
                ...
                result.unsafeNonWebbyInitiator = decoder0.readBoolean(12, 1);
                }
                {
                    
                result.disableWebSecurity = decoder0.readBoolean(12, 2);
                }
                {
                    
                result.isTrusted = decoder0.readBoolean(12, 3);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.unsafeNonWebbyInitiator, 12, 1);
        
        encoder0.encode(this.disableWebSecurity, 12, 2);
        
        encoder0.encode(this.isTrusted, 12, 3);
