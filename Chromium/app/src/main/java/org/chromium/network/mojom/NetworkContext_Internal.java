...
class NetworkContext_Internal {
    ...
    private static final int SET_CORS_EXTRA_SAFELISTED_REQUEST_HEADER_NAMES_ORDINAL = 48;

    private static final int DELETE_DYNAMIC_DATA_FOR_HOST_ORDINAL = 49;

    private static final int SET_SPLIT_AUTH_CACHE_BY_NETWORK_ISOLATION_KEY_ORDINAL = 50;

    private static final int SAVE_HTTP_AUTH_CACHE_PROXY_ENTRIES_ORDINAL = 51;

    private static final int LOAD_HTTP_AUTH_CACHE_PROXY_ENTRIES_ORDINAL = 52;

    private static final int ADD_AUTH_CACHE_ENTRY_ORDINAL = 53;

    private static final int LOOKUP_SERVER_BASIC_AUTH_CREDENTIALS_ORDINAL = 54;

    private static final int ENABLE_STATIC_KEY_PINNING_FOR_TESTING_ORDINAL = 55;

    private static final int SET_FAILING_HTTP_TRANSACTION_FOR_TESTING_ORDINAL = 56;

    private static final int VERIFY_CERTIFICATE_FOR_TESTING_ORDINAL = 57;

    private static final int ADD_DOMAIN_RELIABILITY_CONTEXT_FOR_TESTING_ORDINAL = 58;

    private static final int FORCE_DOMAIN_RELIABILITY_UPLOADS_FOR_TESTING_ORDINAL = 59;

    private static final int GET_ORIGIN_POLICY_MANAGER_ORDINAL = 60;
...
org.chromium.mojo.bindings.InterfaceRequest<RestrictedCookieManager> restrictedCookieManager, int role, org.chromium.url.internal.mojom.Origin origin, org.chromium.url.mojom.Url siteForCookies, org.chromium.url.internal.mojom.Origin topFrameOrigin, boolean isServiceWorker, int processId, int routingId) {
...
org.chromium.url.mojom.Url url, String[] requestedProtocols, org.chromium.url.mojom.Url siteForCookies, NetworkIsolationKey networkIsolationKey, HttpHeader[] additionalHeaders, int processId, int renderFrameId, org.chromium.url.internal.mojom.Origin origin, int options, WebSocketHandshakeClient handshakeClient, AuthenticationHandler authHandler, TrustedHeaderClient headerClient) {
...
SetCorsOriginAccessListsForOriginResponse callback) {
        ...
        @Override
        public void setCorsExtraSafelistedRequestHeaderNames(
String[] corsExtraSafelistedRequestHeaderNames) {

            NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams _message = new NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams();

            _message.corsExtraSafelistedRequestHeaderNames = corsExtraSafelistedRequestHeaderNames;


            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(SET_CORS_EXTRA_SAFELISTED_REQUEST_HEADER_NAMES_ORDINAL)));
...
org.chromium.mojo.bindings.InterfaceRequest<OriginPolicyManager> originPolicyManager) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case GET_RESTRICTED_COOKIE_MANAGER_ORDINAL: {
                        ...
                        getImpl().getRestrictedCookieManager(data.restrictedCookieManager, data.role, data.origin, data.siteForCookies, data.topFrameOrigin, data.isServiceWorker, data.processId, data.routingId);
                        return true;
                    }
                    ...
                    case NOTIFY_EXTERNAL_CACHE_HIT_ORDINAL: {
                        ...
                        getImpl().notifyExternalCacheHit(data.url, data.httpMethod, data.key);
                        return true;
                    }
                    ...
                    case CREATE_WEB_SOCKET_ORDINAL: {
                        ...
                        getImpl().createWebSocket(data.url, data.requestedProtocols, data.siteForCookies, data.networkIsolationKey, data.additionalHeaders, data.processId, data.renderFrameId, data.origin, data.options, data.handshakeClient, data.authHandler, data.headerClient);
                        return true;
                    }
                    ...
                    case CREATE_QUIC_TRANSPORT_ORDINAL: {
                        ...
                        getImpl().createQuicTransport(data.url, data.origin, data.networkIsolationKey, data.handshakeClient);
                        return true;
                    }
                    ...
                    case SET_CORS_EXTRA_SAFELISTED_REQUEST_HEADER_NAMES_ORDINAL: {

                        NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams data =
                                NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams.deserialize(messageWithHeader.getPayload());

                        getImpl().setCorsExtraSafelistedRequestHeaderNames(data.corsExtraSafelistedRequestHeaderNames);
                        return true;
                    }
    ...
    static final class NetworkContextGetRestrictedCookieManagerParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkContextGetRestrictedCookieManagerParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new NetworkContextGetRestrictedCookieManagerParams(elementsOrVersion);
                    ...
                    result.isServiceWorker = decoder0.readBoolean(40, 0);
                    }
                    {
                        
                    result.processId = decoder0.readInt(44);
                    }
                    {
                        
                    result.routingId = decoder0.readInt(48);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.isServiceWorker, 40, 0);
            
            encoder0.encode(this.processId, 44);
            
            encoder0.encode(this.routingId, 48);
        }
    }
    ...
    static final class NetworkContextCreateWebSocketParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkContextCreateWebSocketParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new NetworkContextCreateWebSocketParams(elementsOrVersion);
                    ...
                    result.handshakeClient = decoder0.readServiceInterface(68, false, WebSocketHandshakeClient.MANAGER);
                    }
                    {
                        
                    result.authHandler = decoder0.readServiceInterface(76, true, AuthenticationHandler.MANAGER);
                    }
                    {
                        
                    result.headerClient = decoder0.readServiceInterface(84, true, TrustedHeaderClient.MANAGER);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.handshakeClient, 68, false, WebSocketHandshakeClient.MANAGER);
    ...
    static final class NetworkContextCreateQuicTransportParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkContextCreateQuicTransportParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new NetworkContextCreateQuicTransportParams(elementsOrVersion);
                    ...
                    result.handshakeClient = decoder0.readServiceInterface(32, false, QuicTransportHandshakeClient.MANAGER);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.handshakeClient, 32, false, QuicTransportHandshakeClient.MANAGER);
        }
    }
    ...
    static final class NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams extends org.chromium.mojo.bindings.Struct {
        ...
        private NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams(int version) {
            super(STRUCT_SIZE, version);
        }
        ...
        public static NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new NetworkContextSetCorsExtraSafelistedRequestHeaderNamesParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            if (this.corsExtraSafelistedRequestHeaderNames == null) {
                ...
                org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.corsExtraSafelistedRequestHeaderNames.length, 8, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
