...
public final class ContentSecurityPolicy extends org.chromium.mojo.bindings.Struct {
    ...
    public static ContentSecurityPolicy decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new ContentSecurityPolicy(elementsOrVersion);
                ...
                result.useReportingApi = decoder0.readBoolean(16, 0);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.useReportingApi, 16, 0);
        
        if (this.reportEndpoints == null) {
            encoder0.encodeNullPointer(24, false);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.reportEndpoints.length, 24, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
