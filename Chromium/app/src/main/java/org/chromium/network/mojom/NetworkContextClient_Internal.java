...
class NetworkContextClient_Internal {
    ...
    private static final int ON_COOKIES_CHANGED_ORDINAL = 7;

    private static final int ON_COOKIES_READ_ORDINAL = 8;
...
boolean isServiceWorker, int processId, int routingId, org.chromium.url.mojom.Url url, org.chromium.url.mojom.Url siteForCookies, CookieWithStatus[] cookieList) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(ON_COOKIES_CHANGED_ORDINAL)));
...
OnGenerateHttpNegotiateAuthTokenResponse callback) {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ON_COOKIES_CHANGED_ORDINAL: {

                        NetworkContextClientOnCookiesChangedParams data =
                                NetworkContextClientOnCookiesChangedParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case ON_COOKIES_READ_ORDINAL: {
                        ...
                        NetworkContextClientOnCookiesReadParams data =
                                NetworkContextClientOnCookiesReadParams.deserialize(messageWithHeader.getPayload());

                        getImpl().onCookiesRead(data.isServiceWorker, data.processId, data.routingId, data.url, data.siteForCookies, data.cookieList);
                        return true;
                    }
    ...
    static final class NetworkContextClientOnCookiesChangedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkContextClientOnCookiesChangedParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static NetworkContextClientOnCookiesChangedParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static NetworkContextClientOnCookiesChangedParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            NetworkContextClientOnCookiesChangedParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new NetworkContextClientOnCookiesChangedParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            if (this.cookieList == null) {
                ...
                org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.cookieList.length, 40, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
    ...
    static final class NetworkContextClientOnCookiesReadParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkContextClientOnCookiesReadParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static NetworkContextClientOnCookiesReadParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static NetworkContextClientOnCookiesReadParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            NetworkContextClientOnCookiesReadParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new NetworkContextClientOnCookiesReadParams(elementsOrVersion);
                    {
