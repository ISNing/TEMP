...
class NetworkService_Internal {
    ...
    private static final int BIND_TEST_INTERFACE_ORDINAL = 25;
...
int processId) {
        ...
        @Override
        public void addExtraMimeTypesForCorb(
String[] mimeTypes) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(ADD_EXTRA_MIME_TYPES_FOR_CORB_ORDINAL)));
...
org.chromium.mojo.bindings.InterfaceRequest<NetworkServiceTest> receiver) {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ADD_EXTRA_MIME_TYPES_FOR_CORB_ORDINAL: {

                        NetworkServiceAddExtraMimeTypesForCorbParams data =
                                NetworkServiceAddExtraMimeTypesForCorbParams.deserialize(messageWithHeader.getPayload());

                        getImpl().addExtraMimeTypesForCorb(data.mimeTypes);
                        return true;
                    }
    ...
    static final class NetworkServiceAddExtraMimeTypesForCorbParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkServiceAddExtraMimeTypesForCorbParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static NetworkServiceAddExtraMimeTypesForCorbParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static NetworkServiceAddExtraMimeTypesForCorbParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            NetworkServiceAddExtraMimeTypesForCorbParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new NetworkServiceAddExtraMimeTypesForCorbParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            if (this.mimeTypes == null) {
                ...
                org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.mimeTypes.length, 8, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
