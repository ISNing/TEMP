...
public final class UrlResponseHead extends org.chromium.mojo.bindings.Struct {
    ...
    public static UrlResponseHead decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new UrlResponseHead(elementsOrVersion);
                ...
                result.certStatus = decoder0.readInt(176);
                }
                {
                ...
                result.contentSecurityPolicy = ContentSecurityPolicy.decode(decoder1);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.serviceWorkerStartTime, 152, false);
        
        encoder0.encode(this.serviceWorkerReadyTime, 160, false);
        
        encoder0.encode(this.cacheStorageCacheName, 168, false);
        
        encoder0.encode(this.certStatus, 176);
        
        encoder0.encode(this.sslInfo, 184, true);
        
        if (this.corsExposedHeaderNames == null) {
            encoder0.encodeNullPointer(192, false);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.corsExposedHeaderNames.length, 192, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        ...
        encoder0.encode(this.authChallengeInfo, 200, true);
        
        encoder0.encode(this.contentSecurityPolicy, 208, true);
        
        encoder0.encode(this.requestStart, 216, false);
        
        encoder0.encode(this.responseStart, 224, false);
        
        encoder0.encode(this.originPolicy, 232, true);
        
        encoder0.encode(this.recursivePrefetchToken, 240, true);
    }
}