...
public final class Display extends org.chromium.mojo.bindings.Struct {
    ...
    public static Display decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new Display(elementsOrVersion);
                ...
                result.colorDepth = decoder0.readInt(64);
                }
                {
                    
                result.depthPerComponent = decoder0.readInt(68);
                }
                {
                    
                result.isMonochrome = decoder0.readBoolean(72, 0);
                }
                {
                    
                result.displayFrequency = decoder0.readInt(76);
                }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.colorDepth, 64);
        
        encoder0.encode(this.depthPerComponent, 68);
        
        encoder0.encode(this.isMonochrome, 72, 0);
        
        encoder0.encode(this.displayFrequency, 76);
    }
}